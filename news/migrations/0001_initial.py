...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('news', ['FeedSubscription'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('news_feedsubscription')
    ...
    models = {
        ...
        'news.feedsubscription': {
            ...
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['news.NewsFeed']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
